...
#ifndef NewAnalyzer_dacapo_h
#define NewAnalyzer_dacapo_h
...
class NewAnalyzer_dacapo {
 public :



//Variabili Giordano per istogrammi
  int Nbin_eta=50;
  float binMax_eta=3.5;
  int Nbin_pt=50;
  float binMax_pt=300;
  int Nbin_deltaB=30;
  float binMax_deltaB=0.5;
...
Float_t Btag_disc_cut;
  ...
  TH1F *hist_eff, *hist_jetacc, *Minv_Cat1,  *Minv_Cat2, *hist_trueMet, *histHP_trueMet, *hist_prefiring, *hist_bjet_pt_inclusive/*,*hist_eta_for_pt26,*hist_pt_for_eta24,*hist_DeltaB,*hist_eta,*hist_pt*/ ;
  std::map<TString, TH1F *> histos;
  //TH3F *hist_eta_pt;

TH1F *hist_eta_for_pt26= new TH1F("filtro_eta per pt=26  ","Efficienza filtro <= EtaMax per ptmin=26; #eta; N°eventi", Nbin_eta, 0.0, binMax_eta);
   TH1F *hist_pt_for_eta24= new TH1F("filtro_ pt per eta=2.4","Efficienza filtro >= PtMin per etamax=24;Pt(GeV); N°eventi", Nbin_pt, 0, binMax_pt );
   TH1F *hist_DeltaB= new TH1F("filtro_DeltaB","Efficienza filtro <=Delta B", 200, 0.10, 0.40);
   TH1F *hist_eta= new TH1F("filtro_eta","Efficienza filtro <= EtaMax", Nbin_eta, 0.0, binMax_eta);
   TH1F *hist_pt= new TH1F("filtro_pt","Efficienza filtro >= PtMin;Pt(GeV); N°eventi", Nbin_pt, 0, binMax_pt );
   TH2F *hist_eta_pt= new TH2F("filtro_eta pt","Efficienza eta pt", Nbin_eta, 0.0, binMax_eta, Nbin_pt, 0.0, binMax_pt);
   TH2F *hist_eta_deltaB= new TH2F("filtro_deltaB_di_eta_","Efficienza_filtro_Iso_eta);#eta;Isolamento;Efficiency", Nbin_eta, 0.0, binMax_eta, Nbin_deltaB, 0.0, binMax_deltaB);
TH2F *hist_pt_deltaB= new TH2F("filtro deltaB_(pt)","Efficienza_filtro_Iso_pt);Pt(GeV);Isolamento;Efficiency", Nbin_pt, 0.0, binMax_pt, Nbin_deltaB, 0.0, binMax_deltaB);

//Efficienza_filtro_eta_pt
	//before
  TH1F *hist_pt_before_eta_pt_filter=new TH1F("pt_before_eta_pt_filter","Distribution MuonTight's PT before eta-pt filter;Pt(GeV); N°eventi",Nbin_pt, 26, binMax_pt);//
   TH1F *hist_eta_before_eta_pt_filter=new TH1F("Eta before_eta_pt_filter","Distribution MuonTight's Eta before eta-pt filter;#eta;N°eventi",Nbin_eta, -2.4, 2.4);
TH2F *hist_eta_pt_before_eta_pt_filter=new TH2F("Eta_pt_before_eta_pt_filter","Distribution MuonTight's ETA-PT before eta-pt filter;#eta;Pt(GeV); N°eventi",Nbin_eta,-2.4,2.4,Nbin_pt, 26, binMax_pt);
 TH1F *hist_px_before_eta_pt_filter=new TH1F("px_before_eta_pt_filter","Distribution MuonTight's Px _before_eta_pt_filter;Px(GeV); N°eventi",100,0,200);//
   TH1F *hist_py_before_eta_pt_filter=new TH1F("py_before_eta_pt_filter","Distribution MuonTight's Py _before_eta_pt_filter;Py(GeV);N°eventi",100,0,200);//
   TH1F *hist_pz_before_eta_pt_filter=new TH1F("pz_before_eta_pt_filter","Distribution MuonTight's Pz _before_eta_pt_filter;Pz(GeV); N°eventi",100,0,200);//
   TH1F *hist_en_before_eta_pt_filter=new TH1F("en_before_eta_pt_filter","Distribution MuonTight's En _before_eta_pt_filter;En(Gev);N°eventi",100,0,500);//
   TH1F *hist_phi_before_eta_pt_filter=new TH1F("phi_before_eta_pt_filter","Distribution MuonTight's Phi _before_eta_pt_filter;#phi; N°eventi",100,-M_PI,M_PI);//
   TH1F *hist_charge_before_eta_pt_filter=new TH1F("charge_before_eta_pt_filter","Distribution MuonTight's Charge _before_eta_pt_filter;charge;N°eventi",5,-2,2);//
	//after sono quelli di Before Iso

	//efficienza
TH1F *histEff_eta_ptFilter_eta= new TH1F("Efficienza_filtro_eta_pt_Eta","Efficienza_filtro_eta_pt(Eta);#eta; Efficiency",Nbin_eta, -2.4, 2.4);
TH1F *histEff_eta_ptFilter_pt= new TH1F("Efficienza_filtro_eta_pt_Pt","Efficienza_filtro_eta_pt(Pt);Pt(GeV); Efficiency",Nbin_pt, 26, binMax_pt);
 TH2F *histEff_eta_ptFilter_eta_pt=new TH2F("Efficienza_filtro_eta_pt_Eta_Pt_","Efficienza_filtro_eta_pt(Pt-eta);#eta;Pt(GeV); Efficiency",Nbin_eta,-2.4,2.4,Nbin_pt, 26, binMax_pt);
TH1F *histEff_eta_ptFilter_px= new TH1F("Efficienza_filtro_eta_pt_Px","Efficienza_filtro_eta_pt(Px);PX(GeV); Efficiency",100, 0, 200);//
TH1F *histEff_eta_ptFilter_py= new TH1F("Efficienza_filtro_eta_pt_Py","Efficienza_filtro_eta_pt(Py);Py(GeV); Efficiency",100, 0,200);//
TH1F *histEff_eta_ptFilter_pz= new TH1F("Efficienza_filtro_eta_pt_Pz","Efficienza_filtro_eta_pt(Pz);Pz(Gev); Efficiency",100, 0, 200);//
TH1F *histEff_eta_ptFilter_en= new TH1F("Efficienza_filtro_eta_pt_En","Efficienza_filtro_eta_pt(En);En(GeV); Efficiency",100, 0, 500);//
TH1F *histEff_eta_ptFilter_phi= new TH1F("Efficienza_filtro_eta_pt_Phi","Efficienza_filtro_eta_pt(#Phi);#phi; Efficiency",100, -M_PI,M_PI );//
TH1F *histEff_eta_ptFilter_charge= new TH1F("Efficienza_filtro_eta_pt_Charge","Efficienza_filtro_eta_pt(Charge);Charge; Efficiency",5, -2, 2);//
  
 //Efficienza Filtro iso
   	//before
   TH1F *hist_pt_before_iso_filter=new TH1F("pt_before_iso_filter","Distribution MuonTight's PT_before_iso_filter;Pt(GeV); N°eventi",Nbin_pt, 26, binMax_pt);
   TH1F *hist_eta_before_iso_filter=new TH1F("Eta_before_iso_filter","Distribution MuonTight's Eta_before_iso_filter;#eta;N°eventi",Nbin_eta, -2.4, 2.4);
  TH2F *hist_eta_pt_before_iso_filter=new TH2F("Eta-pt_before_iso_filter","Distribution MuonTight's ETA-PT_before_iso_filter;#eta;Pt(GeV); N°eventi",Nbin_eta,-2.4,2.4,Nbin_pt, 26, binMax_pt);
   TH1F *hist_px_before_iso_filter=new TH1F("px_before_iso_filter","Distribution MuonTight's Px_before_iso_filter;Px(GeV); N°eventi",100,0,200);
   TH1F *hist_py_before_iso_filter=new TH1F("py_before_iso_filter","Distribution MuonTight's Py_before_iso_filter;Py(GeV);N°eventi",100,0,200);
   TH1F *hist_pz_before_iso_filter=new TH1F("pz_before_iso_filter","Distribution MuonTight's Pz_before_iso_filter;Pz(GeV); N°eventi",100,0,200);
   TH1F *hist_en_before_iso_filter=new TH1F("en_before_iso_filter","Distribution MuonTight's En_before_iso_filter;En(Gev);N°eventi",100,0,500);
   TH1F *hist_phi_before_iso_filter=new TH1F("phi_before_iso_filter","Distribution MuonTight's Phi_before_iso_filter;#phi; N°eventi",100,-M_PI,M_PI);
   TH1F *hist_charge_before_iso_filter=new TH1F("charge_before_iso_filter","Distribution MuonTight's Charge_before_iso_filter;charge;N°eventi",5,-2,2);//
	//after
 
   TH1F *hist_pt_after_iso_filter=new TH1F("pt_after_iso_filter","Distribution MuonTight's PT_after_iso_filter;Pt(GeV); N°eventi",Nbin_pt, 26, binMax_pt);
   TH1F *hist_eta_after_iso_filter=new TH1F("Eta_after_iso_filter","Distribution MuonTight's Eta_after_iso_filter;#eta;N°eventi",Nbin_eta, -2.4, 2.4);
   TH2F *hist_eta_pt_after_iso_filter=new TH2F("Eta-pt_after_iso_filter","Distribution MuonTight's ETA-PT_after_iso_filter;#eta;Pt(GeV); N°eventi",Nbin_eta,-2.4,2.4,Nbin_pt, 26, binMax_pt);
   TH1F *hist_px_after_iso_filter=new TH1F("px_after_iso_filter","Distribution MuonTight's Px_after_iso_filter;Px(GeV); N°eventi",100,0,200);
   TH1F *hist_py_after_iso_filter=new TH1F("py_after_iso_filter","Distribution MuonTight's Py_after_iso_filter;Py(GeV);N°eventi",100,0,200);
   TH1F *hist_pz_after_iso_filter=new TH1F("pz_after_iso_filter","Distribution MuonTight's Pz_after_iso_filter;Pz(GeV); N°eventi",100,0,200);
   TH1F *hist_en_after_iso_filter=new TH1F("en_after_iso_filter","Distribution MuonTight's En_after_iso_filter;En(GeV);N°eventi",100,0,500);
   TH1F *hist_phi_after_iso_filter=new TH1F("phi_after_iso_filter","Distribution MuonTight's Phi_after_iso_filter;#phi; N°eventi",100,-M_PI,M_PI);
   TH1F *hist_charge_after_iso_filter=new TH1F("charge_after_iso_filter","Distribution MuonTight's Charge_after_iso_filter;charge;N°eventi",5,-2,2);//
 	//efficienza
TH1F *histEff_IsoFilter_eta= new TH1F("Efficienza_filtro_Iso_Eta","Efficienza_filtro_Iso_Eta);#eta; Efficiency",Nbin_eta, -2.4, 2.4);
TH1F *histEff_IsoFilter_pt= new TH1F("Efficienza_filtro_Iso_Pt_","Efficienza_filtro_Iso_Pt);Pt(GeV); Efficiency",Nbin_pt, 26, binMax_pt);
 TH2F *histEff_IsoFilter_eta_pt=new TH2F("Efficienza_filtro_Iso_Eta-Pt_","Efficienza_filtro_Iso_Pt-eta);#eta;Pt(GeV); Efficiency",Nbin_eta,-2.4,2.4,Nbin_pt, 26, binMax_pt);
TH1F *histEff_IsoFilter_px= new TH1F("Efficienza_filtro_Iso_Px_","Efficienza_filtro_Iso_Px);PX(GeV); Efficiency",100, 0, 200);
TH1F *histEff_IsoFilter_py= new TH1F("Efficienza_filtro_Iso_Py_","Efficienza_filtro_Iso_Py);Py(GeV); Efficiency",100, 0,200);
TH1F *histEff_IsoFilter_pz= new TH1F("Efficienza_filtro_Iso_Pz_","Efficienza_filtro_Iso_Pz);Pz(Gev); Efficiency",100, 0, 200);
TH1F *histEff_IsoFilter_en= new TH1F("Efficienza_filtro_Iso_En_","Efficienza_filtro_Iso_En);En(GeV); Efficiency",100, 0, 500);
TH1F *histEff_IsoFilter_phi= new TH1F("Efficienza_filtro_Iso_Phi_","Efficienza_filtro_Iso_#Phi);#phi; Efficiency",100, -M_PI,M_PI);
TH1F *histEff_IsoFilter_charge= new TH1F("Efficienza_filtro_Iso_Charge_","Efficienza_filtro_Iso_Charge);Charge; Efficiency",5, -2, 2);//
...
TH1F *hist_;
  //==================================
TH1F *hist_mass_inclusive_pre_MCut= new TH1F("hist_mass_inclusive_pre_MCut","dimuon mass inclusive; mass (GeV); events",500,0.,500.);
TH1F *hist_pt_inclusive_pre_MCut = new TH1F("hist_pt_inclusive_pre_MCut","dimuon p_{T} inclusive; p_{T} (GeV); events",500,0.,500.);
TH1F * hist_pz_inclusive_pre_MCut= new TH1F("hist_pz_inclusive_pre_MCut","dimuon p_{z} inclusive; p_{z} (GeV); events",500,0.,500.);
TH1F *hist_p_inclusive_pre_MCut = new TH1F("hist_p_inclusive_pre_MCut","dimuon p inclusive; p (GeV); events",500,0.,500.);
TH1F *hist_eta_inclusive_pre_MCut = new TH1F("hist_eta_inclusive_pre_MCut","dimuon #eta inclusive; #eta; events",80,-10.,10.);
TH1F *hist_phi_inclusive_pre_MCut= new TH1F("hist_phi_inclusive_pre_MCut","dimuon #phi inclusive; #phi; events",32,-M_PI,M_PI);

TH1F *hist_mass_inclusive_post_MCut= new TH1F("hist_mass_inclusive_post_MCut","dimuon mass inclusive; mass (GeV); events",500,0.,500.);
TH1F *hist_pt_inclusive_post_MCut = new TH1F("hist_pt_inclusive_post_MCut","dimuon p_{T} inclusive; p_{T} (GeV); events",500,0.,500.);
TH1F * hist_pz_inclusive_post_MCut= new TH1F("hist_pz_inclusive_post_MCut","dimuon p_{z} inclusive; p_{z} (GeV); events",500,0.,500.);
TH1F *hist_p_inclusive_post_MCut = new TH1F("hist_p_inclusive_post_MCut","dimuon p inclusive; p (GeV); events",500,0.,500.);
TH1F *hist_eta_inclusive_post_MCut = new TH1F("hist_eta_inclusive_post_MCut","dimuon #eta inclusive; #eta; events",80,-10.,10.);
TH1F *hist_phi_inclusive_post_MCut= new TH1F("hist_phi_inclusive_post_MCut","dimuon #phi inclusive; #phi; events",32,-M_PI,M_PI);

//Jet

TH1F *hist_N_jet_btag_for_event=new TH1F{"Number_Btag_in_event","Number of b-tagged jet in events;#b-tag;Nevent",5,1,5};
TH1F *hist_N_jet2_btag_for_event=new TH1F{"Number_Btag2_in_event","Number of b-tagged jet2 in events;#b-tag;Nevent",5,1,5};
TH1F *hist_bdisc=new TH1F("Bdisc_Distribution","Bdisc_Distribution",1000,0,1);

TH1F *hist_energy_MEt_btag_event=new TH1F("MEt_Btag","Energy MEt of b-tagged event",1000,0,200);
TH1F *hist_energy_MEt_non_btag_event=new TH1F("MEt_notBtag","Energy MEt of non b-tagged event",1000,0,200);


TH1F *hist_pt_MEt_btag_event=new TH1F("Pt_MEt_Btag","Pt MEt of b-tagged event",1000,0,200);
TH1F *hist_pt_MEt_non_btag_event=new TH1F("Pt_MEt_notBtag","Pt MEt of non b-tagged event",1000,0,200);
 ...
 //==================================
  ...
  Short_t         NpfMet;//Questa va salvata nel tree (in for loop su NpfMet)
  vector<float>   *Met_pt_pfmet; 
  ...
  NewAnalyzer_dacapo(TString dataset, float mA, float min, float max, int ScaleCorrection, bool HptReweight,int Nbin_eta_=100,double binMax_eta_=3,int Nbin_pt_=100, double binMax_pt_=100, TTree *tree=0);
  virtual ~NewAnalyzer_dacapo();
...
#ifdef NewAnalyzer_dacapo_cxx
NewAnalyzer_dacapo::NewAnalyzer_dacapo(TString dataset, float mA, float min, float max, int ScaleCorrection, bool HptReweight,int Nbin_eta_,double binMax_eta_,int Nbin_pt_, double binMax_pt_, TTree *tree) // : fChain(0) 
{ //assegno i parametri per gli istogrammi
/*  Nbin_eta=Nbin_eta_;
  binMax_eta=binMax_eta_;
  Nbin_pt=Nbin_pt_ ;
  binMax_pt=binMax_pt_;*/
  ...
  //  chain -> Add(sel_dataset); //////////////////////////////////////////////////////////////////////////
    ...
    if(sel_dataset == "bbA_MA300_Tanb-20")
      chain->Add("/home/giordano/Scrivania/laurea/dataset_MC/MSSMbbA-HiggsToMuMu_MA-300_Tanb-20_13TeV_pythia8_Merged.root"); 
    ...
    if(sel_dataset == "ggH_MA900_Tanb-60")
      chain->Add("/eos/cms/store/user/federica/Moriond18/V2/MSSMggH-HiggsToMuMu_MA-900_Tanb-60_13TeV_pythia8_Merged.root"); 
    ...
    if(sel_dataset == "DY_nlo1")
      chain->Add("/home/giordano/Scrivania/laurea/dataset_MC/NTuple_mc_DYJetsToLL_M-50_asymptotic_Moriond17_nlo_ext_Merged.root");
    ...
    if(sel_dataset == "ttbar_nlo")
      chain->Add("/home/giordano/Scrivania/laurea/dataset_MC/NTuple_mc_TTbarJets_nlo_Merged.root"); 
...
NewAnalyzer_dacapo::~NewAnalyzer_dacapo()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t NewAnalyzer_dacapo::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t NewAnalyzer_dacapo::LoadTree(Long64_t entry)
{
...
void NewAnalyzer_dacapo::Init(TTree *tree)
{
...
Bool_t NewAnalyzer_dacapo::Notify()
{
...
void NewAnalyzer_dacapo::Show(Long64_t entry)
{
...
Int_t NewAnalyzer_dacapo::Cut(Long64_t entry)
{
